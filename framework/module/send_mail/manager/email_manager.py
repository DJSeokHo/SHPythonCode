...
from framework.module.send_mail.manager.sender.email_sender import EmailSender
from framework.util.debug.debug_util import ILog
from framework.util.uuid.uuid_util import UUIDUtil
import time
...
class EmailManager:
    ...
    def create_sender(self):
        ...
        self.__email_sender = EmailSender(UUIDUtil.uuid(), EmailManager.__ID, EmailManager.__PW,
